...
const Header = () => {
	...
	return (
		<header style={{ position:'fixed', zIndex:999, top:0, left:0, width:'100%', height:70, backgroundColor:'#FFFFFF', border:'1px solid #EFEAE5', boxSizing:'border-box', boxShadow:'0px 2px 20px rgba(0, 0, 0, 0.05)'}}>
			<div style={{position:'relative', width:1024, height:70, marginLeft:'auto', marginRight:'auto', paddingLeft:50, paddingRight:50}}>
				...
				{authToken ? (
					<div style={{float:'right', width:70, marginTop:22.5}}>
						<a
							style={{font:"Roboto", fontWeight:'bold', fontSize:"15px", color:'#3E3F41'}}
						onClick={(e) => {
							e.preventDefault();
							deleteUserToken();
